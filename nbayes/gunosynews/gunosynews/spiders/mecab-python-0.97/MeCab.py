...
class DictionaryInfo(_object):
    ...
    def __init__(self, *args): 
        this = _MeCab.new_DictionaryInfo(*args)
...
class Node(_object):
    ...
    def begin_node_list(*args): return _MeCab.Node_begin_node_list(*args)
    def end_node_list(*args): return _MeCab.Node_end_node_list(*args)
...
class Tagger(_object):
    ...
    __repr__ = _swig_repr
    def parse(*args): return _MeCab.Tagger_parse(*args)
    def parseToNode(*args): return _MeCab.Tagger_parseToNode(*args)
    def parseNBest(*args): return _MeCab.Tagger_parseNBest(*args)
    def parseNBestInit(*args): return _MeCab.Tagger_parseNBestInit(*args)
    def nextNode(*args): return _MeCab.Tagger_nextNode(*args)
    def next(*args): return _MeCab.Tagger_next(*args)
    def formatNode(*args): return _MeCab.Tagger_formatNode(*args)
    def partial(*args): return _MeCab.Tagger_partial(*args)
    def set_partial(*args): return _MeCab.Tagger_set_partial(*args)
    def theta(*args): return _MeCab.Tagger_theta(*args)
    def set_theta(*args): return _MeCab.Tagger_set_theta(*args)
    def lattice_level(*args): return _MeCab.Tagger_lattice_level(*args)
    def set_lattice_level(*args): return _MeCab.Tagger_set_lattice_level(*args)
    def all_morphs(*args): return _MeCab.Tagger_all_morphs(*args)
    def set_all_morphs(*args): return _MeCab.Tagger_set_all_morphs(*args)
    def dictionary_info(*args): return _MeCab.Tagger_dictionary_info(*args)
    def what(*args): return _MeCab.Tagger_what(*args)
    ...
    def parseToString(*args): return _MeCab.Tagger_parseToString(*args)
